...
class Particle extends TexRegion {
    constructor({ imgId, metaId, frame, pos, lifetime, velX, velY, accX, accY, alpha, alphaDecayFn, rotVel, loop }) {
...
class ParticleEmitter extends Node {
    constructor({ size, blendMode, hitbox, loop = false, randomDistribution = true, metaId, imgId, params, ...nodeProps }) {
        super({ ...nodeProps })
        this.hitbox = hitbox
