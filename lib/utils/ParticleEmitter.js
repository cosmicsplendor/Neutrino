...
class Particle extends TexRegion {
    constructor({ imgId, metaId, frame, pos, lifetime, velX, velY, accX, accY, alpha, alphaDecayFn, loop }) {
...
/**
 * const types = [
 *     { frame, offsetX = 0, offsetY = 0, lifetime: [ 2, 5 ], velX, velY, accX, accY, alpha, alphaDecayFn, weight = 1 },
 *     { frame, offsetX = 0, offsetY = 0, lifetime: [ 4, 8 ], velX, velY, accX, accY, alpha, alphaDecayFn, weight = 1 },
 * ]
 */
