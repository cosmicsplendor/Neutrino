...
import { colRectsId } from "@lib/constants"
...
class TiledLevel extends  Node {
    ...
    constructor({ player, data, texatlas, factories={}, bg, fbg, ...nodeProps }) {
        ...
        super({ ...nodeProps })
        const colRects = new Node({ id: colRectsId }) // collision rects are invisible, so whenre in the scene graph they go doesn't matter
