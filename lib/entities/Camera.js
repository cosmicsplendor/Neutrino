...
class Camera extends Node {
    constructor({ subject, viewport, world = viewport, z = 1, lExt = 0, rExt = 0, ...nodeProps }) {
        super({ ...nodeProps })
        this.z = z
    ...
    focus() {
        ...
        this.pos.x = this.pF * (-clamp(this.lExt, this.world.width  + this.rExt - this.bounds.width, this.subject.pos.x + this.offset.x - this.bounds.width / 2))
