...
class Collision {
    constructor({ entity, block, blocks, onHit = () => {}, restitution=0, rigid=false, movable=true, }) { // block and blocks are both optional, but one of them must be passed
        /**
         * ------------------------------------
        ...
        this.evaluateUpdateFn = () => { 
            ...
            return getUpdateHandler(this.entity, sampleBlock, { rigid, restitution, collision: this })
        }
    }
    test(resolve) {
        const { entity } = this
