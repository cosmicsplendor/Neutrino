...
export default (entity, block, { rigid = false, restitution, collision, wallJump=false }) => {
    ...
    return () => { // update handler with collison resolution logic
        const movement = { x: entity.pos.x - entity.prevPosX, y: entity.pos.y - entity.prevPosY }
        let xResolved = false
