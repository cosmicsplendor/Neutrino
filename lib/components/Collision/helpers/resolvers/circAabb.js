...
export default  Object.freeze({
    ...
    resolveX: (entity, block, movementX, movable) => {
        ...
        if (xOffset && nearestBlockYFromEntCenter === blockBounds.y) {
            ...
            entity.offCornerX = nearestBlockXFromEntCenter
            entity.offCornerY = blockBounds.y
        }
