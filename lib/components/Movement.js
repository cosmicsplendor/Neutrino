...
import { atan, clamp } from "@utils/math"
export default class Movement {
    ...
    static updateOffEdge(entity, dt) {
        ...
        const tanX = normY
        const tanY = -normX
        const dPos = (clamp(-60, 60, entity.velX) * tanX + 20 * tanY) * dt // dPos projection along tangent (this is the amount by which to move along circumference)
        ...
        switch (entity.offEdge) {
            case -1: // off left-edge
                ...
                if (cond1 || a1 < Math.PI / 6) { // if cond1 or if the angle is less than 45 degrees (in latter case the ball should go to free fall)  
                    entity.offEdge = 0
            ...
            case 1: // off right-edge
                ...
                if (cond1 || a1 > 0.75 * Math.PI) { // 2.35 is (90 + 45) degrees in radians
                    entity.offEdge = 0
