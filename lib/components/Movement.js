...
export default class Movement {
    ...
    static updateOffEdge(entity, dt) {
        ...
        const tanX = normY
        const tanY = -normX
        const dPos = (Math.min(entity.velX, 80) * tanX + 20 * tanY) * dt // dPos projection along tangent (this is the amount by which to move along circumference)
