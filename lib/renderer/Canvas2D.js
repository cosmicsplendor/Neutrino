...
class Canvas2DRenderer {
    ...
    render(node) {
        // node.smooth ? this.ctx.translate(node.pos.x, node.pos.y): this.ctx.translate(Math.floor(node.pos.x), Math.floor(node.pos.y))
        // this.ctx.translate(node.pos.x, node.pos.y)
