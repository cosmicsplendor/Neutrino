...
class Webgl2Renderer {
    ...
    collectInstanceDataByBatch(node, batches) {
        ...
        this.instanceData.mat.push(...mat); // Assuming mat is a flat array of 9 elements
        this.instanceData.texMat.push(...texMat);
        this.instanceData.tint.push(...(tint || this.defTint));
        this.instanceData.alpha.push(alpha !== undefined ? alpha : this.alpha);
