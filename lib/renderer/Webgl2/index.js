...
class Webgl2Renderer {
    ...
    set alpha(val) {
        this.stateStack.active.alpha = val
    }
    ...
    render(node) {
        ...
        if (this._alpha !== this.stateStack.active.alpha) { // gpu cache
            this._alpha = this.stateStack.active.alpha
            gl.uniform1f(this.uAlpha, this._alpha)
        }
        gl.uniformMatrix3fv(uMat, false, this.stateStack.active.mat)
