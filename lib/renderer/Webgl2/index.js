...
class Webgl2Renderer {
    ...
    resize({ width, height }) {
        ...
        this.matrixUtil.scale(this.firstMat, 2/this.viewport.width, -2/this.viewport.height);
    }
    initProgram() {
        const gl = this.gl;
    ...
    pushTransposedMatrix(arr, mat) { // transpose into row-major order
        arr.push(
            mat[0], mat[3], mat[6],
            mat[1], mat[4], mat[7],
            mat[2], mat[5], mat[8]
    ...
    collectInstanceData(node) {
        ...
        // this.translate(-1, 1)
        // this.scale(2 / this.viewport.width, -2 /  this.viewport.height)
        console.log(this.getCurMat())
